...
namespace HRTimer
{
    class HiResTimer
    {
        ...
        {
            a = b = 0UL;
            if (QueryPerformanceFrequency(out f) == 0) //use hisolution clock
        ...
        public ulong ElapsedMicroseconds//translate clock tick to high resolutino time
        {
            get
            {
                ulong d = (b - a);
        ...
        [DllImport("kernel32.dll", SetLastError = true)]//talk to windows API
